...
describe("TW1.1 sortDishes", function tw1_1_20() {
    ...
    it("sort order should be: 'no type', starter, main course, dessert (export sortDishes to enable)", function  tw1_1_20_2(){
        ...
        assert.equal(sorted[2], array[3], "starter should be second");
        assert.equal(sorted[3], array[0], "main course should be third");
        assert.equal(sorted[4], array[1], "dessert should be fourth");
    });
